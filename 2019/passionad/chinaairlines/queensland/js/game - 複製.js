...
var fb_login = function(){
	...
	FB.login(function(response) {
	  if (response.authResponse) {
		// console.log("fb_login -> fb_api_me");
		fb_api_me();
	  } else {
...
$(function(){
	...
	*/
	// ciq.game.compatibility.scrollTo = false;
	// console.log(ciq.game);
	resize();
	...
	// $('#activitydatablock .db').on('focus', function() {
		// document.body.scrollTop = $(this).offset().top;
	// });
	// $('#activitydatablock .db').on('focusin', function() {
		// document.body.scrollTop = $(this).offset().top;
	// });
	// $('#activitydatablock .db').on('focusout', function() {
		// document.body.scrollTop = $(this).offset().top;
	// });	
	// $('#activitydatablock .db').on('blur', function() {
		// document.body.scrollTop = $(this).offset().top;
	// });
		...
		$.ajax({
			...
			data: {
				...
				if(response.code=="success"){
					logs('inside', 'view', '10');
					formInit();
					 $('#activitydatablock .success').html("資料送出成功。");
